...
// Tạo vé cho BangKok
const bangKokTicket1 = new Ticket('Bangkok', 'Vé Công Viên Dream World ở Bangkok', 'Công viên giải trí', 150000, './assets/images/ThaiLand/img_1.jpg');
const bangKokTicket2 = new Ticket('Bangkok', 'Vé Công Viên Siam Amazing Park ở Bangkok', 'Công viên giải trí', 200000, './assets/images/ThaiLand/img_2.jpg');
const bangKokTicket3 = new Ticket('Bangkok', 'Vé Lumphini Park', 'Công viên giải trí', 200000, './assets/images/ThaiLand/img_3.jpg');
const bangKokTicket4 = new Ticket('Bangkok', 'Vé Công Viên Nước Pororo AquaPark ở Bangkok', 'Công viên nước', 200000, './assets/images/ThaiLand/img_4.jpg');
...
thailand.addTicket(chiangMaiTicket1);
thailand.addTicket(chiangMaiTicket2);
thailand.addTicket(chiangMaiTicket3);
thailand.addTicket(chiangMaiTicket4);
thailand.addTicket(chiangMaiTicket5);
thailand.addTicket(chiangMaiTicket6);
thailand.addTicket(chiangMaiTicket7);
thailand.addTicket(chiangMaiTicket8);
thailand.addTicket(chiangMaiTicket9);
thailand.addTicket(chiangMaiTicket10);

thailand.addTicket(phuketTicket1);
thailand.addTicket(phuketTicket2);
thailand.addTicket(phuketTicket3);
thailand.addTicket(phuketTicket4);
thailand.addTicket(phuketTicket5);
thailand.addTicket(phuketTicket6);
thailand.addTicket(phuketTicket7);
thailand.addTicket(phuketTicket8);
thailand.addTicket(phuketTicket9);
thailand.addTicket(phuketTicket10);

thailand.addTicket(krabiTicket1);
thailand.addTicket(krabiTicket2);
thailand.addTicket(krabiTicket3);
thailand.addTicket(krabiTicket4);
